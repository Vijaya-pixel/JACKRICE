        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-border px-6 py-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-sm font-bold leading-tight text-foreground">Verify your identity</p>
            ...
            {stage === "intro" && (
              <>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Before viewing the clinical dashboard, confirm you are a licensed
                  clinician. You will be asked for:
                </p>
          ...
          <div className="border-t border-border px-6 py-3">
            <p className="font-mono text-[10px] leading-relaxed text-muted-foreground">
              &gt; prototype note: persona verification is simulated — no identity
              data is collected or checked.
            </p>
          </div>
        </section>
      </div>
