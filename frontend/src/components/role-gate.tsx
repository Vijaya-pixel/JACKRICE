  ...
  if (role !== "clinician") {
    return (
      <main className="machine-page flex min-h-svh flex-col bg-muted/40 pt-[76px]">
        <SiteHeader />
        <div className="page-copy-reveal machine-display mx-auto flex w-full max-w-[1500px] flex-1 items-center justify-center px-5 py-10 md:px-8">
          <section className="machine-module w-full max-w-md origin-center transform-gpu animate-in fade-in zoom-in-50 duration-1000 rounded-xl border-2 border-border bg-card p-6 text-center motion-reduce:animate-none">
